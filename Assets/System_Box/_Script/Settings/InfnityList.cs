...
namespace SystemBox
{
    ...
    [System.Serializable]
    public class InfnityList<T> : ICollection<T>, IEnumerable<T>, IEnumerable, IList<T>, IReadOnlyCollection<T>, IReadOnlyList<T>, ICollection, IList
    {
        public InfnityList() { }
        public InfnityList(T ts)
        {
            try
            {
                NList.Clear();
        ...
        public InfnityList(InfnityList<T> ts)
        {
            try
            {
                NList.Clear();
        ...
        public InfnityList(params T[] ts)
        {
            try
            {
                NList.Clear();
        ...
        public InfnityList(IEnumerable<T> collection)
        {
            try
            {
        ...
        public IEnumerator<T> GetEnumerator() => NList.GetEnumerator();
        ...
        public InfnityList<T> Rotate(bool AsNew = false)//Tested
        {
            try
            {
                if (!AsNew)
        ...
        /// <returns></returns>
        public InfnityList<T> SetCount(int NCount, bool AsNew = false)//Tested
        {
            try
            {
        ...
        public InfnityList<T> Mix(bool AsNew = false)//Tested
        {
            try
            {
                if (!AsNew)
        ...
        public InfnityList<T> AddAndReturn(T item) //Tested
        {
            try
            {
                NList.Add(item);
        ...
        public InfnityList<T> AddTo(int Index, T item)
        {
            try
            {
        ...
        /// <param name="Index"> index to start adding </param>
        public InfnityList<T> AddTo(int Index, TList<T> items) //Tested
        {
            try
            {
                List<T> Newlist = new List<T>();
        ...
        /// <param name="items"> Item </param>
        /// <param name="Index"> index to start adding </param>
        public InfnityList<T> AddTo(int Index, params T[] items)  //Tested
        {
            try
            {
                List<T> Newlist = new List<T>();
        ...
        /// <param name="items"> Item </param>
        /// <param name="Index"> index to start adding </param>
        public InfnityList<T> AddTo(int Index, List<T> items) //Tested
        {
            try
            {
                List<T> Newlist = new List<T>();
        ...
        public InfnityList<T> AddManyTo(T item, int HowMatch, int Index)//Tested
        {
            try
            {
                InfnityList<T> Newlist = new InfnityList<T>();
                for (int i = 0; i < NList.Count; i++)
                {
                    if (i == Index)
                    {
        ...
        public InfnityList<T> AddIf(T item, bool Test)
        {
            if (!Test) return this;
            try
            {
        ...
        public InfnityList<T> AddIf(IEnumerable<T> item, bool Test)
        {
            if (!Test) return this;
            try
            {
        ...
        public InfnityList<T> AddIfDirty(T item)
        {
            try
            {
        ...
        #region implicit
        public static implicit operator T[](InfnityList<T> v)
        {
            try
            {
        ...
        public static implicit operator InfnityList<T>(T[] v)
        {
            try
            {
                return new InfnityList<T>(v);
            }
            catch (System.Exception XX) { throw Tools.ExceptionThrow(XX, 2); }
        }
        public static implicit operator InfnityList<T>(List<T> v)
        {
            try
            {
                return new InfnityList<T>(v);
        ...
        public static implicit operator List<T>(InfnityList<T> v)
        {
            try
            {
                return new List<T>(v);
        ...
        #region operator 
        public static InfnityList<T> operator +(InfnityList<T> left, T right)
        {
            try
            {
