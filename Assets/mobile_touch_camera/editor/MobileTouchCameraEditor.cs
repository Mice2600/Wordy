...
namespace BitBenderGames {
  ...
  public class MobileTouchCameraEditor : CustomInspector {
    ...
    public void OnSceneGUI() {
      ...
      var fmh_41_57_638160447606233314 = Quaternion.identity; pBottomLeft = Handles.FreeMoveHandle(pBottomLeft, handleSize, Vector3.one, Handles.SphereHandleCap);
      var fmh_42_53_638160447606258719 = Quaternion.identity; pTopRight = Handles.FreeMoveHandle(pTopRight, handleSize, Vector3.one, Handles.SphereHandleCap);
      ...
      var fmh_48_70_638160447606262111 = Quaternion.identity; Vector3 pBottomRightNew = Handles.FreeMoveHandle(pBottomRight, handleSize, Vector3.one, Handles.SphereHandleCap);
      var fmh_49_62_638160447606265043 = Quaternion.identity; Vector3 pTopLeftNew = Handles.FreeMoveHandle(pTopLeft, handleSize, Vector3.one, Handles.SphereHandleCap);
    ...
    private Vector3 DrawOneWayHandle(MobileTouchCamera mobileTouchCamera, float handleSize, Vector2 pRelative, float offset) {
      ...
      var fmh_82_56_638160447606277126 = Quaternion.identity; Vector3 pointNew = Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.DotHandleCap);
