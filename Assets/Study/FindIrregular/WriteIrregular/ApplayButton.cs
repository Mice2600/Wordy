...
namespace Study.WriteIrregular
{
    ...
    {
        private WriteIrregularSystem WriteIrregularSystem;
        ...
        private void Start()
        {
            ...
            WriteIrregularSystem = GetComponentInParent<WriteIrregularSystem>();
        }
        void Update()
        {
            ...
            {
                if (!Lis[i].gameObject.GetComponent<WI_Conttent>().IsEvrethingWroten) 
                {
                    text.text = "Write";
